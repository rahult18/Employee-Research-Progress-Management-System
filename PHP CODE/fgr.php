...
<div id="main">
	<center><h3 style="font-family:Century">Generic Research</h3></center>	
		<div class="in_con">
		<form action="fgr.php" method="post" enctype="multipart/form-data">
			...
			<input type="text" placeholder="Hypothesis" name="hy"><br>
			<input type="text" placeholder="Article Referred" name="acr"><br>
	...
	<?php
		if(isset($_POST['addres']))
		{
			...
			$nr=mysqli_num_rows($new);
			$new1=mysqli_fetch_array($new);$rid=$new1["r_id"];
			if($nr>2)
			{
			...
			else
			{
				...
				@$sd=$_POST['sd'];@$ed=$_POST['ed'];@$hy=$_POST['hy'];@$acr=$_POST['acr'];
				$q="insert into research_details (R_TITLE,STATUS,RESEARCH_DOM,START_DATE,END_DATE,TYPE,HYPOTHESIS,ARTICLE_REFFERED,AMOUNT_GRANTED)values('$rt','$status','$rsd','$sd','$ed','Generic Research','$hy','$acr',null)";
